  ...
  <div class="row">
      <div class="col">
        <div class="card bg-secondary text-white text-center p-4 mb-4">
          ...
          <p>Schedule exams at your own convenience and choose from various time slots.</p>
          <a href="create-exam.php?user=<?=$id?>" class="btn btn-primary">Schedule Exams</a>
        </div>
      </div>
    </div>
    ...
    <div class="row mx-1">
      <div class="col">
        <div class="card bg-secondary text-white text-center p-4 mb-4">
          ...
          <p>View your exams results and track your Students progress over time.</p>
          <a href="exams.php?user=<?=$id?>" class="btn btn-primary">View Your Exams</a>
        </div>
      </div>
    </div>

        ...
        <div class="col-10">
            ...
            <tbody>
                ...
                foreach($exams as $exam){
                    ...
                    $grade = getgrade($id, $exam->exam_id);
                ...
                <td><?php print_r( $exam->duration); echo "minutes"?></td>
                <td>
                  <?php if((($id)==($i_d)) && (($e_x)==($ex))) {?>
                    <a href="" class="btn btn-warning">Taken!</a>
                    <?php }else{ ?>
                      <a href="take-exam.php?user=<?=$id?>&exam=<?php echo $exam->exam_id?>" class="btn btn-primary">Take Exam</a>
                </td>
                <?php } }?>
            </tbody>
            </table>
